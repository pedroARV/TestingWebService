...
/**
 * <p>Clase Java para createAdjustmentResponseType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="createAdjustmentResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "createAdjustmentResponseType", propOrder = {
    "code",
    "message"
})
public class CreateAdjustmentResponseType {
